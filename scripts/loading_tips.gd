...
const TIPS: Array[String] = [
	...
	"Detuning an engine lowers its torque to meet a rally's power limit.",
	"Ballast adds weight to lower a car's power-to-weight ratio.",
	"Every engine swap costs one token, even reverting to a car's stock engine.",
	"Damage depends on how hard you decelerate, not how fast you were going.",
	"Only the free pit repair between events restores lost health.",
	"A hard impact can bend a wheel out of alignment until it's repaired.",
	"Heavy damage makes an engine misfire before it fully gives out.",
