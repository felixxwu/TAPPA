...
# and the full standard set (1-6, Square, Hairpin, Jump, Straight) present. "Jump" is
# straight in plan view on purpose — its shape is VERTICAL, and lives in TrackProfile.


const EXPECTED := [
	"1", "2", "3", "4", "5", "6",
	"Square", "Hairpin", "Jump", "Straight",
]
