...
| [perks.md](perks.md) | The perk catalogue (`PerkLibrary`) and its locked → purchasable → owned → equipped state machine — money-bought, gated on lifetime stats, capped by `GameConfig.perk_max_equipped`. No gameplay effects wired yet |
